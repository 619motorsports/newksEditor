...
bounce-back, exact soft-edge, and raw-UV operations remain unsupported or approximated.
...
vertex-anchor selection, raw-UV procedural mapping, fog/open-door cast lights, flat-normal
