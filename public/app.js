...
function renderModelInspector(file, nodes, triangles) {
  ...
  const supplementalHtml = fbxImportInspectorHtml() + workspaceInspectorHtml() + packedDataInspectorHtml() + carHierarchyInspectorHtml() + carColliderInspectorHtml() + driverInspectorHtml() + trackCameraInspectorHtml() + trackValidationInspectorHtml() + shaderProfilesInspectorHtml() + tyrePreviewInspectorHtml() + brakeDiscPreviewInspectorHtml() + vaoInspectorHtml() + seasonalInspectorHtml() + weatherLightingInspectorHtml() + reflectionCaptureInspectorHtml() + lightingInspectorHtml() + grassFxInspectorHtml() + rainFxInspectorHtml() + animationInspectorHtml() + skinTextureInspectorHtml() + externalTextureInspectorHtml(), materialSection = inspector.querySelector(".section:last-child");
...
function createRenderer(canvas) {
  ...
  function setModel(model) {
    ...
    refreshBrakeDiscStatus();api.onTyreStatus?.(api.tyreStatus);api.onBrakeDiscStatus?.(api.brakeDiscStatus);refreshAnimationWorlds();frame();
  }
