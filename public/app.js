...
function renderModelInspector(file, nodes, triangles) {
  ...
  const supplementalHtml = fbxImportInspectorHtml() + workspaceInspectorHtml() + packedDataInspectorHtml() + carHierarchyInspectorHtml() + carColliderInspectorHtml() + driverInspectorHtml() + trackCameraInspectorHtml() + trackValidationInspectorHtml() + shaderProfilesInspectorHtml() + tyrePreviewInspectorHtml() + rimBlurInspectorHtml() + cockpitPreviewInspectorHtml() + brakeDiscPreviewInspectorHtml() + vaoInspectorHtml() + seasonalInspectorHtml() + weatherLightingInspectorHtml() + reflectionCaptureInspectorHtml() + lightingInspectorHtml() + grassFxInspectorHtml() + rainFxInspectorHtml() + animationInspectorHtml() + skinTextureInspectorHtml() + externalTextureInspectorHtml(), materialSection = inspector.querySelector(".section:last-child");
...
function createRenderer(canvas) {
  ...
  function setModel(model) {
    ...
    refreshBrakeDiscStatus();refreshRimBlurStatus();refreshCockpitPreviewStatus();api.onTyreStatus?.(api.tyreStatus);api.onBrakeDiscStatus?.(api.brakeDiscStatus);api.onRimBlurStatus?.(api.rimBlurStatus);api.onCockpitPreviewStatus?.(api.cockpitPreviewStatus);refreshAnimationWorlds();frame();
  }
