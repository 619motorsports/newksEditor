...
import { applyCarDamageEdits, captureCarDamageBaseline, carDamageEditCount as countCarDamageEdits, parseCarDamageIni, serializeCarDamageIni } from "/src/car-damage.js";
...
async function configureCarDamage() {
  ...
  try{
    ...
    if(bytes.byteLength>1048576)throw new Error("damage.ini is larger than the 1 MiB input limit");
    const text=new TextDecoder("utf-8",{fatal:true}).decode(bytes);
    carDamageConfig=parseCarDamageIni(text,entry.relativePath);
