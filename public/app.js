...
function createRenderer(canvas) {
  ...
  const program = link(gl, `#version 300 es
    ...
    void main(){
      ...
      vec2 customUv=customUseRawUv?vUv:fract(vUv);if(customMirrorUv.x>0.5){vec2 mirrorDirection=customMirrorUv.zw;float signedDistance=dot(mirrorDirection,customUv)-customMirrorUv.y;if(signedDistance<0.0)customUv-=2.0*signedDistance*mirrorDirection;}
