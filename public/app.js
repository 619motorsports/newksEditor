...
function createRenderer(canvas) {
  ...
  function setModel(model) {
    ...
    refreshBrakeDiscStatus();api.onTyreStatus?.(api.tyreStatus);api.onBrakeDiscStatus?.(api.brakeDiscStatus);refreshAnimationWorlds();refreshDynamicTrackStatus();frame();
  }
