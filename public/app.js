...
function createRenderer(canvas) {
  ...
  function setModel(model) {
    ...
    sceneModel=model;refreshAnalogRpmBinding();shaderProfileStatus=auditMaterialShaderProfiles(model.materials);reflectionCaptureRoot=null;reflectionCubeInitialized=false;reflectionNextFace=0;
