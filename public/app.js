...
function createRenderer(canvas) {
  ...
  function setModel(model) {
    ...
    refreshTyreStatus();refreshBrakeDiscStatus();refreshAnimationWorlds();refreshDynamicTrackStatus();frame();
  }
  ...
  function refreshHierarchy() {
    splitAoAnimationScope=splitAoAnimationNodeScope(sceneRoot,currentAnimation);refreshAnalogRpmBinding();refreshAnimationWorlds(); reflectionCubeInitialized=false; reflectionNextFace=0; scheduleGrassRebuild(); draw();
  }
