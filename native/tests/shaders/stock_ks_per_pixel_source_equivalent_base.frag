...
// Evidence-backed source equivalent for the base stock ksPerPixel pixel
// stage. See docs/evidence/stock-ks-per-pixel-native-abi.md and the recorded
// base pixel SHA-256 there. This file is a source reference, not a claim that
// a GLSL compiler emits the original DXBC instruction stream.
...
void main() {
    ...
    // The base package uses the interpolated normal directly. It does not
    // normalize or inverse-transpose the normal in the pixel stage.
