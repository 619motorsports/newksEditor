...
// This is intentionally the same vertex contract as indexed_ks_per_pixel_nm.vert.
// The separate source file keeps the maps fixture provenance self-contained.
