...
// Source authority: public/app.js:2075-2083, with maps fallback vec3(1).
// This fixture deliberately excludes Fresnel/reflection and generic detail.
...
void main() {
    ...
    // public/app.js:2080 fallback is vec3(1.0) when txMaps is absent. This
    // fixture exercises the bound txMaps path, so no maps flag is needed.
