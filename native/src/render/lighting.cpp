...
const std::array<CubemapFace,6>& stockCubemapFaces() noexcept { static const std::array<CubemapFace,6> faces={CubemapFace{{-1,0,0},{0,1,0},"negative-x"},{{1,0,0},{0,0,1},"positive-x"},{{0,1,0},{0,0,-1},"positive-y"},{{0,-1,0},{0,0,1},"negative-y"},{{0,0,1},{0,1,0},"positive-z"},{{0,0,-1},{0,1,0},"negative-z"}};return faces; }
