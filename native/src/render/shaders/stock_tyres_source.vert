...
// Source-equivalent static mesh basis for the recovered ksTyres pixel path.
// The handedness follows the recovered cross(normal, tangent) order.
...
void main() {
    ...
    fragmentBitangent = world3 * cross(normal, tangent);
